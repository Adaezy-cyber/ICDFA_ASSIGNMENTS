# Evidence Bundle 05: Policy Review and Maintenance Memo

**To:** Information Security Steering Committee  
**From:** Adaeze Adeteye, Information Security Manager  
...
I recommend two specific AUP updates. First, add a clearer **approved-cloud-services requirement** stating that company and client information must only be stored, transferred, or shared through organisation-approved cloud services and that personal cloud storage is prohibited for sensitive information unless a documented exception has been approved. Second, strengthen the **remote working and information-sharing section** with clearer examples of prohibited sharing methods and a requirement to verify recipients before sending sensitive information. The Information Security Manager should own the update, with input from IT/Cloud, HR, Legal/Compliance, and relevant business/data owners, followed by approval through the Information Security Steering Committee and designated executive authority. The AUP should continue to undergo a formal annual review, with an early review triggered by material technology changes, significant incidents, regulatory or contractual changes, audit findings, or identified control weaknesses. Kindly review these recommendations and revert, so i can have it documented.
